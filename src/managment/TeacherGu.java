 ...
 * @author habiba
 */
public class TeacherGu extends javax.swing.JFrame {
Connection con;
    /**
     * Creates new form TeacherGu
     */
    public TeacherGu() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Manage Attendance");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherGu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
